...
resource "aws_cloudfront_cache_policy" "tfer--17322e93-4707-445a-93bc-6c8c16621822" {
...
resource "aws_cloudfront_cache_policy" "tfer--1b1c9610-973a-4fb9-9932-a6c274840887" {
...
resource "aws_cloudfront_cache_policy" "tfer--4c02794c-7c81-4ba1-8b5d-e05fb0f95ed8" {
...
resource "aws_cloudfront_cache_policy" "tfer--766eb028-1aff-4eb2-a5a4-2674e1538f26" {
  comment     = "Amplify cache policy for image optimization"
  default_ttl = "0"
  max_ttl     = "31536000"
  min_ttl     = "0"
